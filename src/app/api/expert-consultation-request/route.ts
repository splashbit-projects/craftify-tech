...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    const userMsg = {
      ...
      subject: 'Your Expert Consultation Request Has Been Received',
      html: `
                      ...
                      <table style="width: 100%;">
                          <tr>
                              ...
                              border-left: 1px solid rgba(4, 2, 19, 0.08);">
                                  ...
                                  line-height: 110%;
                                  margin: 0 0 24px 0;">
                                      Your Expert Consultation Request Has Been Received
                                  </h2>
                                  ...
                                  line-height: normal;
                                  margin: 0 0 24px 0;">
                                      Thank you for submitting your expert consultation request to Craftify Tech. We have
                                  ...
                                  line-height: normal;
                                  margin: 0 0 24px 0;">
                                      An expert will review your request and contact you as soon as possible to provide
                                      tailored guidance for your business needs.
                                  </p>
                                  ...
                                  line-height: normal;
                                  margin: 0 0 24px 0;">
                                      Craftify Tech connects enterprises with the right cybersecurity expertise, ensuring the
                                      right insights reach the right team at the right time.
                                  </p>
                                  ...
                                  line-height: normal;
                                  margin: 0 0 24px 0;">
                                      We look forward to helping you navigate your cybersecurity priorities.
                                  </p>
