...
import styles from './IndustriesExperts.module.scss';

export const IndustriesExperts = () => {
  const t = useTranslations('industriesExperts');

  return (
    <section className={styles.industries_experts}>
      <div className={'_container'}>
        <div className={styles.industries_experts__content}>
          <div className={styles.industries_experts__col_1}>
          ...
          <div className={styles.industries_experts__col_2}>
            <motion.h2
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
